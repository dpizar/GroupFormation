...
public abstract class SoenEAConnection implements Connection{

	Connection innerConnection;
	
	@SuppressWarnings("unused")
	private SoenEAConnection(){};
	
	public SoenEAConnection(Connection conn)
	{
		innerConnection = conn;
	}
	
	public abstract void lockTable(String tableName) throws SQLException;
	
	public abstract void unlockTable(String tableName) throws SQLException;
